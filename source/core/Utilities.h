...
namespace weave
{
		...
		{
			using ContextTuple = std::tuple<typename Module<typename NodeDescriptors::Tag>::ContextType...>;
		};

		template <typename... EdgeDescriptors>
		struct DescriptorListToContextTuple<EdgeDescriptorList<EdgeDescriptors...>>
		{
			using ContextTuple = std::tuple<typename BufferData<typename EdgeDescriptors::Tag>::ContextType...>;
		};
		...
		{
			using NodeContextTuple = std::tuple<typename Module<typename NodeDescriptors::Tag>::ContextType...>;
			using EdgeContextTuple = std::tuple<typename BufferData<typename EdgeDescriptors::Tag>::ContextType...>;
		};
		...
		{
			using NodesTuple = std::tuple<typename Module<typename NodeDescriptors::Tag>::ContextType...>;
			using EdgesTuple = std::tuple<typename BufferData<typename EdgeDescriptors::Tag>::ContextType...>;
		};
