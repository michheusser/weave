...
namespace weave
{
		...
		public:
			...
			explicit Builder(typename DescriptorListToContextTuple<NodeDescriptorListType>::ContextTuple nodeContexts, typename DescriptorListToContextTuple<EdgeDescriptorListType>::ContextTuple edgeContexts) : _nodeContexts(nodeContexts), _edgeContexts(edgeContexts)
			{}
			...
			Builder<typename AppendToList<NodeDescriptorListType, NodeDescriptor<ModuleTag, numInputs, numOutputs>>::NewDescriptorListType, EdgeDescriptorListType> addNode(const typename Module<ModuleTag>::ContextType& context)
			{
			...
			Builder<NodeDescriptorListType, typename AppendToList<EdgeDescriptorListType, EdgeDescriptor<BufferDataTag, FromModule, ToModule>>::NewDescriptorListType> addEdge(const typename BufferData<BufferDataTag>::ContextType& context)
			{
