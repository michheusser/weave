...
namespace weave::profiling
{
	std::string ConfigurationPrinter::print(const std::string& sessionName,
	                                        const std::string& sessionDescription,
	                                        std::vector<std::shared_ptr<ConfigurationDataNode>>& configurationDataTrees)
	{
	...
	std::string ConfigurationPrinter::printNode(const std::shared_ptr<ConfigurationDataNode>& node,
	...
	void ConfigurationPrinter::dumpToJson(const std::string& filename,
	                                      std::vector<std::shared_ptr<ConfigurationDataNode>>& configurationDataTrees)
	{
		try
		{
	...
	std::string ConfigurationPrinter::nodeToJson(const std::shared_ptr<ConfigurationDataNode>& node,
	                                             int indentLevel)
	{
