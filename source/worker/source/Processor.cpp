...
namespace weave
{
	namespace worker
	{
		...
		Error::Result Processor<Constants::Module::Capturer>::process(buffer::Buffer<Module::Traits<moduleType>::buffers[0], Module::Traits<moduleType>::bufferPolicies[0]>::StorageType& outputBuffer,
		...
		Error::Result Processor<Constants::Module::Displayer>::process(
			const buffer::Buffer<Module::Traits<moduleType>::buffers[0], Module::Traits<moduleType>::bufferPolicies[0]>::StorageType& inputBuffer, uint32_t frameID) noexcept
		{
		...
		Error::Result Processor<Constants::Module::ImageProcessor>::process(
			const buffer::Buffer<Module::Traits<moduleType>::buffers[0], Module::Traits<moduleType>::bufferPolicies[0]>::StorageType& inputBuffer,
		...
		Error::Result Processor<Constants::Module::ImageToTensor>::process(
			const buffer::Buffer<Module::Traits<moduleType>::buffers[0], Module::Traits<moduleType>::bufferPolicies[0]>::StorageType& inputBuffer,
			buffer::Buffer<Module::Traits<moduleType>::buffers[1], Module::Traits<moduleType>::bufferPolicies[1]>::StorageType& outputBuffer) noexcept
		{
		...
		Error::Result Processor<Constants::Module::Inference>::process(
			const buffer::Buffer<Module::Traits<moduleType>::buffers[0], Module::Traits<moduleType>::bufferPolicies[0]>::StorageType& inputBuffer,
			buffer::Buffer<Module::Traits<moduleType>::buffers[1], Module::Traits<moduleType>::bufferPolicies[1]>::StorageType& outputBuffer) noexcept
		{
		...
		Error::Result Processor<Constants::Module::ClientReceiver>::process(
			buffer::Buffer<Module::Traits<moduleType>::buffers[0], Module::Traits<moduleType>::bufferPolicies[0]>::StorageType& outputBuffer, uint32_t* frameID) noexcept
		{
		...
		Processor<Constants::Module::ClientSender>::Processor(const Module::Context<Constants::Module::ClientSender>& context) : _networkClient(context.networkClient),
		                                                                                                                         _encoder(context.encoderConfiguration),
		                                                                                                                         _bufferConfiguration(context.bufferConfiguration)
		{}
		...
		Error::Result Processor<Constants::Module::ClientSender>::process(
			const buffer::Buffer<Module::Traits<moduleType>::buffers[0], Module::Traits<moduleType>::bufferPolicies[0]>::StorageType& inputBuffer, uint32_t frameID) noexcept
		{
		...
		Error::Result Processor<Constants::Module::ServerReceiver>::process(
			buffer::Buffer<Module::Traits<moduleType>::buffers[0], Module::Traits<moduleType>::bufferPolicies[0]>::StorageType& outputBuffer, uint32_t* frameID) noexcept
		{
		...
		Error::Result Processor<Constants::Module::ServerSender>::process(
			const buffer::Buffer<Module::Traits<moduleType>::buffers[0], Module::Traits<moduleType>::bufferPolicies[0]>::StorageType& inputBuffer, uint32_t frameID) noexcept
		{
			Error::Result resultEncode = _encoder.encodeFrameIntoBuffer(inputBuffer, _buffer, frameID);
			if (!resultEncode.ok())
